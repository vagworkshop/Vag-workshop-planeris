...
function validateEvent(data) {
  ...
  if (!data.start || !data.end) {
    ...
    // "Pabaiga turi būti vėlesnė už pradžią" lygina tik laiką (HH:MM), tad
    // taikoma TIK vienos dienos darbui. Kelių dienų darbui (dateTo > dateFrom)
    // pabaigos laikas paskutinę dieną gali būti bet koks — pvz. pradžia
    // pirmadienį 09:30, pabaiga antradienį 09:00 yra visiškai tvarkinga.
    if (dateTo === data.dateFrom && data.end <= data.start) errors.push('Pabaiga turi būti vėlesnė už pradžią.');
